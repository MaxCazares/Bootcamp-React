...
export const users: User[] = [
	{
		...
		about: 'Desarrolladora frontend creativa con 6 años de experiencia creando interfaces web modernas. Entusiasta de los sistemas de diseño y optimización de rendimiento.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Ingeniero backend experimentado especializado en sistemas distribuidos y desarrollo de APIs.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Desarrolladora full stack apasionada por el código limpio y soluciones escalables.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Ingeniero DevOps con enfoque en automatización e infraestructura en la nube.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Ingeniera de software apasionada por construir aplicaciones web performantes y accesibles.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Ingeniero senior con sólida experiencia en aplicaciones web empresariales.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Ingeniera enfocada en entregar aplicaciones escalables y mentorizar equipos.',
		experience: [
			{
				...
				period: '2018 - Presente',
				description:
					'Desarrollé aplicaciones nativas en la nube y APIs.',
			},
		],
		stats: {
			projects: 19,
	...
	},
	{
		...
		about: 'Ingeniero frontend con un ojo agudo para el detalle y la experiencia de usuario.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Desarrolladora enfocada en construir aplicaciones web accesibles y responsivas.',
		experience: [
			{
	...
	},
	{
		...
		about: 'Arquitecto diseñando infraestructuras en la nube seguras y escalables.',
		experience: [
			{
				...
				description:
					'Diseñé infraestructura para aplicaciones de gran escala.',
			},
			{
				role: 'Ingeniero DevOps',
				company: 'SysOps Inc.',
